...
Java.perform(function() {
    ...
    let d = Java.use("com.huawei.secure.android.common.webview.SafeWebView$d");
    d["doUpdateVisitedHistory"].overload('android.webkit.WebView', 'java.lang.String', 'boolean').implementation = function (webView, str, z) {

        console.log(`d.doUpdateVisitedHistory is called: webView=${webView}, str=${str}, z=${z}`);
        WebViewClient.doUpdateVisitedHistory.implementation(webView, str, z);
    };


    let SafeWebView = Java.use("com.huawei.secure.android.common.webview.SafeWebView");

    SafeWebView.loadUrl.overload('java.lang.String', 'java.util.Map').implementation = function (str, map) {
        console.log(`SafeWebView.loadUrl is called: str=${str}, map=${map}`);
        WebView.loadUrl.implementation(str, map);
    };

    SafeWebView.loadUrl.overload('java.lang.String').implementation = function (str) {
        console.log(`SafeWebView.loadUrl is called: str=${str}`);
        WebView.loadUrl.implementation(str);
    };


    let DevSettingsModule = Java.use("com.facebook.react.modules.debug.DevSettingsModule");
        DevSettingsModule["setIsDebuggingRemotely"].overload('boolean').implementation = function (z) {
            console.log(`DevSettingsModule.setIsDebuggingRemotely is called: z=${z}`);
            this["setIsDebuggingRemotely"](true);
        };

    let DevInternalSettings = Java.use("com.facebook.react.devsupport.DevInternalSettings");
        DevInternalSettings["isRemoteJSDebugEnabled"].overload().implementation = function () {
            console.log(`DevInternalSettings.isRemoteJSDebugEnabled is called`);
            return true;
    };


    let DevSupportManagerBase = Java.use("com.facebook.react.devsupport.DevSupportManagerBase");
    DevSupportManagerBase["getDevSupportEnabled"].overload().implementation = function () {
        console.log(`DevInternalSettings.isRemoteJSDebugEnabled is called`);
        return true
    };


    let AnonymousClass4 = Java.use("com.facebook.react.devsupport.DevSupportManagerBase$4");
    AnonymousClass4["onReceive"].overload('android.content.Context', 'android.content.Intent').implementation = function (context, intent) {
        console.log(`AnonymousClass4.onReceive is called: context=${context}, intent=${intent}`);
...
Java.perform(function() {
   ...
   function(touchEvent) {
     console.log("\n[+]Hooking onTouchEvent");
     console.log("[+]Setting setWebContentsDebuggingEnabled() to TRUE");
     this.setWebContentsDebuggingEnabled(true);
